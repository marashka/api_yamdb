    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.IntegerField(null=True, validators=[django.core.validators.MaxValueValidator(10, 'Значение должно быть от 1 до 10.'), django.core.validators.MinValueValidator(1, 'Значение должно быть от 1 до 10.')], verbose_name='Оценка')),
